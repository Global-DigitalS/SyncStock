...
const API_URL = (process.env.REACT_APP_API_URL || (typeof window !== "undefined" ? window.location.origin : "")).replace(/\/$/, "");
const APP_URL = (process.env.REACT_APP_APP_URL || (typeof window !== "undefined" ? window.location.origin : "")).replace(/\/$/, "");
...
const defaultPlans = [
  ...
  },
  {
    ...
    max_stores: 9999,
    features: ["Proveedores ilimitados", "Catálogos ilimitados", "Productos ilimitados", "Tiendas ilimitadas", "8 CRMs: HubSpot, Salesforce, Odoo...", "Soporte dedicado 24/7", "API personalizada", "Facturación personalizada"],
    sort_order: 3,
  },
];
...
const defaultContent = {
  ...
  features: [
    ...
    { icon: "Store", title: "Multi-Tienda", description: "Gestiona WooCommerce, PrestaShop, Shopify, Wix y Magento desde un solo panel centralizado." },
    ...
    { icon: "RefreshCw", title: "CRM Integrado", description: "Sincroniza con Dolibarr, Odoo, HubSpot, Salesforce, Zoho, Pipedrive y más CRMs desde un solo panel." },
    ...
    { icon: "ShoppingBag", title: "Marketplaces", description: "Publica y sincroniza tu catálogo en Amazon, eBay, Miravia, El Corte Inglés, idealo y más de 10 marketplaces." },
  ],
  integrations: [
    ...
    { name: "Wix", icon: "Sparkles", category: "E-commerce" },
    { name: "Magento", icon: "Boxes", category: "E-commerce" },
    { name: "Dolibarr", icon: "Building2", category: "CRM/ERP" },
    { name: "Odoo", icon: "Cpu", category: "CRM/ERP" },
    { name: "HubSpot", icon: "Zap", category: "CRM" },
    { name: "Salesforce", icon: "Cloud", category: "CRM" },
    { name: "Zoho CRM", icon: "BarChart3", category: "CRM" },
    { name: "Pipedrive", icon: "TrendingUp", category: "CRM" },
    { name: "Monday CRM", icon: "Layers", category: "CRM" },
    { name: "Freshsales", icon: "Users", category: "CRM" },
  ...
  how_it_works: [
    ...
    { step: 3, title: "Publica en tus tiendas", description: "Sincroniza automáticamente con WooCommerce, Shopify, PrestaShop, Wix, Magento y tu CRM. Siempre actualizado." },
  ],
  testimonials: [
  ...
  faq: [
    ...
    { question: "¿Qué tiendas online son compatibles?", answer: "Actualmente WooCommerce, Shopify, PrestaShop, Wix eCommerce y Magento. También sincronizamos con 8 CRMs: Dolibarr, Odoo, HubSpot, Salesforce, Zoho, Pipedrive, Monday CRM y Freshsales." },
