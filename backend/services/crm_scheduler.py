...
async def sync_crm_connection(connection_id: str) -> dict:
    ...
    from services.crm_sync import sync_orders_to_dolibarr, sync_products_to_dolibarr, sync_suppliers_to_dolibarr
            ...
            if test_result["status"] != "success":
                await db.crm_connections.update_one(
                    ...
                    {"$set": {
                        ...
                        "last_sync_attempt": datetime.now(UTC).isoformat()
                    }}
                )
