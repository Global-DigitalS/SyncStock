        ...
        default_plans = [
            {
                ...
                "features": ["2 proveedores", "1 catálogo", "1 tienda WooCommerce", "1 feed de marketplace", "Soporte por email", "14 días de prueba premium"],
                "is_active": True,
            ...
            },
            {
                ...
                "price_yearly": 199.99,
                "trial_days": 0,
                "features": ["10 proveedores", "5 catálogos", "2 tiendas WooCommerce", "3 feeds de marketplace", "Sincronización cada 24h", "Soporte prioritario"],
                "is_active": True,
            ...
            },
            {
                ...
                "price_yearly": 499.99,
                "trial_days": 0,
                "features": ["50 proveedores", "20 catálogos", "10 tiendas", "10 feeds de marketplace", "Sync cada 6-24h", "API REST", "Soporte 24/7"],
                "is_active": True,
                "auto_sync_enabled": True,
            ...
            },
            {
                ...
                "max_crm_connections": 999999,
                "max_marketplace_connections": 999999,
                "price_monthly": 199.99,
                "price_yearly": 1999.99,
                "trial_days": 0,
                "features": ["Ilimitado", "Feeds de marketplace ilimitados", "Sync cada 1-24h", "Soporte dedicado", "Onboarding personalizado", "SLA garantizado"],
                "is_active": True,
                "auto_sync_enabled": True,
