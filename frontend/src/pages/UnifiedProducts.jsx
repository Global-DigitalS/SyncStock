...
const UnifiedProducts = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [productsRes, categoriesRes, catalogsRes] = await Promise.all([
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-slate-500">
            {products.length.toLocaleString()} productos únicos por EAN
          </p>
        </div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                data-testid="search-unified-products"
              />
            </div>
            <Select
      ...
      {products.length === 0 ? (
        <div className="empty-state">
          ...
          <h3 className="text-lg font-semibold text-slate-900 mb-2">
            No hay productos con EAN
          </h3>
          <p className="text-slate-500 mb-4">
            Importa productos con código EAN para verlos agrupados aquí
          </p>
        </div>
      ) : (
              ...
              <TableBody>
                {products.map((product) => (
                  <TableRow 
                    ...
                    data-testid={`unified-product-${product.ean}`}
                  >
                    <TableCell>
                      <Checkbox
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        <Button
                          ...
                          data-testid={`view-unified-${product.ean}`}
                        >
      ...
      <Dialog open={showCatalogDialog} onOpenChange={setShowCatalogDialog}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Se añadirá la mejor oferta de cada producto
            </DialogDescription>
          </DialogHeader>
